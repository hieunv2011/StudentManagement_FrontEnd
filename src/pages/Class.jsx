                      ...
                      <td className="px-4 py-2 flex text-2xl">
                        <button>
                          <FaEdit
                            ...
                            data-tooltip-content="Chỉnh sửa thông tin lớp"
                        ...
                        >
                          <MdDeleteForever
                            data-tooltip-id="my-tooltip"
                            data-tooltip-content="Xoá lớp"
                            className="cursor-pointer text-red-500 hover:text-slate-500 ml-2"
                          />
                          <Tooltip id="my-tooltip" />
                        </button>
                        <Link to={`/classgrade/${classdata.id}`}>
                          <FaThList
                            data-tooltip-id="my-tooltip"
                            data-tooltip-content="Xem điểm"
                            className="cursor-pointer text-blue-800 hover:text-slate-500 ml-2"
                          />
                          <Tooltip id="my-tooltip" />
                        </Link>
                      </td>
