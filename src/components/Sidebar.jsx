  ...
  return (
    <>
      <button
        ...
        className="p-3 rounded-xl hover:bg-gray-200 hover:border-gray-400"
          ...
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 bottom-0 left-0 z-50 w-full h-screen max-w-xs border-r-2
                border-zinc-800 bg-zinc-900 custom-scrollbar overflow-y-auto"
              ref={ref}
              aria-label="Sidebar"
              // style={{ overflowY: "scroll" }}
            >
              <div className="flex items-center justify-between p-5 border-b-2 border-zinc-800">
                <span className="text-white text-2xl font-bold flex">
                  <IoLogoElectron className="mx-1 text-4xl"/>
                  HM Education 
                </span>
                <button
                  onClick={() => {
                ...
                <li>
                  ...
                  >
                    <motion.span {...framerText(0)}>
                      <div className="">Quản lý sinh viên</div>
                    </motion.span>
                    ...
                    {systemOpen && (
                      <motion.ul {...framerSubMenu} className="pl-8">
                        <Link to="/datdevice">
                          ...
                          >
                            <motion.span {...framerText(0)}>
                              <div className="">Danh sách sinh viên</div>
                            </motion.span>
                        ...
                        <Link to="/trainningcar">
                          ...
                          >
                            <motion.span {...framerText(0)}>
                              <div className="text-white">Danh sách lớp học</div>
                            </motion.span>
                            <motion.div {...framerItem}>
